---
title: "shouldComponentUpdate vs. memoization hooks"
description: "Both shouldComponentUpdate and memoization hooks (React.memo, useMemo, useCallback) serve the same purpose — to prevent unnecessary re-renders."
---
