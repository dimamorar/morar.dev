---
title: "Class lifecycle vs. useEffect"
description: "`useEffect` replaces most lifecycle methods related to side effects,"
---

## Class lifecycle vs useEffect (including Error Boundaries)
...
If you want — logical continuation with cards:

* **Why Error Boundaries cannot be hooks**
* **What happens when React render throws**
