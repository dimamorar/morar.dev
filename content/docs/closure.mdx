---
title: "Closure"
description: "A closure is a mechanism that allows a function to remember variables from its outer scope even after that outer function has finished executing. The function stores a reference to the environment in which it was created."
---
