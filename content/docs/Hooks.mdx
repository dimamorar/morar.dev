---
title: "Hooks"
description: "Hooks are functions that allow you to use state and React features without classes. They provide declarative management of logic, side effects, and performance "
---
