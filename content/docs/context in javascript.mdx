...
description: "Context (execution context) is the value pointed to by the `this` keyword during code execution."
---
...
1. **Global Context**
    ...
    When code runs outside a function — `this` points to the global object
