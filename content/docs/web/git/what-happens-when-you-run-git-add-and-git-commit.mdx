---
title: "What happens when you run git add and git commit"
description: "`git add` indexes changes, and `git commit` saves a snapshot of the state in the repository history."
---
