...
description: "The methods `call`, `apply`, and `bind` are used for manual management of the context (`this`) of a function. They are available to all functions through the `F"
---
