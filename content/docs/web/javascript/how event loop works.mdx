...
- `queueMicrotask()`
- `MutationObserver`
- _(Node.js)_ `process.nextTick()` — executed **earlier than regular microtasks**
...
- [Asynchronous JavaScript: The Event Loop, Callbacks, Promises, and Async/Await — Medium](https://www.notion.so/Asynchronous-JavaScript-The-Event-Loop-Callbacks-Promises-and-Async-Await-by-Viduni-Wickramara-bc1733f64e3f4aaa974912c88774260e?pvs=21)
