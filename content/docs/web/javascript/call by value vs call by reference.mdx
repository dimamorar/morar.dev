...
description: "In JavaScript, all arguments are passed by value, but if the value is a **reference to an object**, the function receives a **copy of that reference**. Therefor"
---
