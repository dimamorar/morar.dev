...
description: "Modules are isolated files with their own namespace,"
---

## Modules (ES Modules vs CommonJS)

> Modules are isolated files with their own namespace,
> 
> 
> which allow structuring code and managing dependencies.
> 
