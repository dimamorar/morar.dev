---
title: "Context API"
description: "Context API is a built-in React mechanism for passing data through a component tree without having to pass props manually. It solves the *prop drilling* problem"
---
