...
export function CredentialsSection() {
  const credentialsInfo = getCredentialsInfo() as any;
          ...
          <AnimatedSection animation="fade-up" delay={100}>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                {credentialsInfo.certifications.map((cert: any, index: any) => (
                  <div
                    key={index}
          ...
          <AnimatedSection animation="fade-up" delay={200}>
            <div className="space-y-4">
              ...
              <div className="space-y-3 sm:space-y-4">
                {credentialsInfo.education.map((edu: any, index: any) => (
                  <div
                    key={index}
                    className="flex items-start bg-zinc-800/30 p-2 sm:p-3 rounded-lg"
                  >
          ...
          <AnimatedSection animation="fade-up" delay={300}>
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {credentialsInfo.skills.map((skill: any, index: any) => (
